...
paddW_8pt6sqm_Cyp51A_Vgram_Plt
########################################################################################
################################################################################
...
paddY_8pt6sqm_Cyp51A_Vgram_Plt
########################################################################################
paddW_and_Y_8pt6sqm_Cyp51A_Vgram_Plt <- ggarrange(paddW_8pt6sqm_Cyp51A_Vgram_Plt,
                                                  paddY_8pt6sqm_Cyp51A_Vgram_Plt,
                                                  ncol = 2)
saveRDS(paddW_and_Y_8pt6sqm_Cyp51A_Vgram_Plt,
        here::here("FilesForLeon_9June2022",
                   "SpatDep", "Figures",
                   "paddW_and_Y_8pt6sqm_Cyp51A_Vgram_Plt.rds"))
########################################################################################