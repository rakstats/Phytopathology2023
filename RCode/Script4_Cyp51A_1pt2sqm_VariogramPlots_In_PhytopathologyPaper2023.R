...
paddW_1pt2sqm_Cyp51A_Vgram_Plt2 <- paddW_1pt2sqm_Cyp51A_Vgram_Plt +
  ggtitle(bquote(bold(atop("(a) Field-SD-a, 1.2"~m^ 2~"(r)")))) +
  theme(plot.title = element_text(size = 15, face = "bold"),
        legend.text = element_text(size=14))

paddW_1pt2sqm_Cyp51A_Vgram_Plt2
########################################################################################
################################################################################
#1.2a Paddock = Y; variable = Cyp51A; Sampling design = b                      #
################################################################################
# Create the Variogram Cloud
...
paddY_Cyp51A_1pt2sqm_Vgram_Cloud_plt <- paddY_Cyp51A_1pt2sqm_Vgram_Cloud %>% 
  ...
  labs(x = "Distance, h (meter)", 
       y = expression(0.5*(z[s+h] - z[s])^2),
       subtitle = bquote(bold(atop("Field: Y, 1.2"~m^ 2~"(r)")))) +
  xlim(0, 500)
...
paddY_1pt2sqm_Cyp51A_Vgram_Plt2 <- paddY_1pt2sqm_Cyp51A_Vgram_Plt+
  ggtitle(bquote(bold(atop("(b) Field-SD-b, 1.2"~m^ 2~"(r)")))) +
  theme(plot.title = element_text(size = 15),
        legend.text = element_text(size=14))

paddY_1pt2sqm_Cyp51A_Vgram_Plt2
  
########################################################################################
########################################################################################
paddW_and_Y_1pt2sqm_Cyp51A_Vgram_Plt <- (paddW_1pt2sqm_Cyp51A_Vgram_Plt2 | 
                                           paddY_1pt2sqm_Cyp51A_Vgram_Plt2)

test_plt <- (paddW_and_Y_1pt2sqm_Cyp51A_Vgram_Plt/paddW_and_Y_1pt2sqm_Cyp51A_Vgram_Plt/
  paddW_and_Y_1pt2sqm_Cyp51A_Vgram_Plt)

ggsave(here::here("Figures", "test_plt.png"),
       test_plt, height = 12, width= 12)
#################################################################################
saveRDS(paddW_1pt2sqm_Cyp51A_Vgram_Plt2,
        here::here("DerivedData", "paddW_1pt2sqm_Cyp51A_Vgram_Plt.rds"))

saveRDS(paddY_1pt2sqm_Cyp51A_Vgram_Plt2,
        here::here("DerivedData", "paddY_1pt2sqm_Cyp51A_Vgram_Plt.rds"))
################################################################################
